                  ...
                  className={`
                    ...
                    ${
                      answerResult === null
                        ...
                        : answerResult === 'wrong' && index === selectedTile.options.indexOf(
                            selectedTile.options.find((_, i) => i === selectedTile.correctIndex) || ''
                          )
                        ? ''
                        : index === selectedTile.correctIndex && answerResult === 'wrong'
                        ? 'bg-green-500 text-white'
